...
public class KillDoctorLuckyConsoleControllerTest {
  ...
  public void testAddPlayer() {
    ...
    stringBuffer.append("!!Enter initiateGame.\n").append("!!Enter setMansion.\n"
            ...
            ).append("Please provide the name: Please provide the space index: Please provide the maximum "
  ...
  public void testSpaceIncludePlayer() {
    stringBuffer.append("!!Enter initiateGame.\n").append("!!Enter setMansion.\n"
            ...
            ).append("18.Trophy Room], items=[Billiard Cue], players=[human], Doctor Lucky's health=50]\n"
